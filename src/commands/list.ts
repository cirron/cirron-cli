...
async function listDeployments(
  ...
  try {
    ...
    if (!options.all && deployments.length === (options.limit || 20)) {
      logger.info(
        chalk.gray(
          `Showing first ${options.limit || 20} deployments. Use --all to see more.`
        )
      );
    }
  } catch (error) {
...
async function listBuilds(api: CirronApi, options: ListOptions): Promise<void> {
  ...
  try {
    ...
    if (!options.all && builds.length === (options.limit || 20)) {
      logger.info(
        chalk.gray(
          `Showing first ${options.limit || 20} builds. Use --all to see more.`
        )
      );
    }
  } catch (error) {
...
async function listModels(api: CirronApi, options: ListOptions): Promise<void> {
  ...
  try {
    ...
    if (!options.all && models.length === (options.limit || 20)) {
      logger.info(
        chalk.gray(
          `Showing first ${options.limit || 20} models. Use --all to see more.`
        )
      );
    }
  } catch (error) {
...
async function listImages(api: CirronApi, options: ListOptions): Promise<void> {
  ...
  try {
    ...
    if (!options.all && images.length === (options.limit || 20)) {
      logger.info(
        chalk.gray(
          `Showing first ${options.limit || 20} images. Use --all to see more.`
        )
      );
    }
  } catch (error) {
...
async function listRegistry(
  ...
  try {
    ...
    if (!options.all && artifacts.length === (options.limit || 20)) {
      logger.info(
        chalk.gray(
          `Showing first ${options.limit || 20} artifacts. Use --all to see more.`
        )
      );
    }
  } catch (error) {
